            ...
            if (lineData.hasNext()) {
                ...
                switch(lineData.next().trim()) {
                    ...
                    case "port":
                        ...
                        break;
                    case "cship":
                        CargoShip newCargoShip = new CargoShip(lineData, docksMap, portsMap);
                        ...
                        break;
                    case "pship":
                        PassengerShip newPassengerShip = new PassengerShip(lineData, docksMap, portsMap);
                    ...
                    case "person":
                        ...
                        break;   
                    case "job":
                        Job newJob = new Job(lineData, shipsMap);
